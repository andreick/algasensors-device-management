package com.example.algasensors.device.management.api.config.web;

import com.example.algasensors.device.management.api.client.SensorMonitoringClientBadGatewayException;
